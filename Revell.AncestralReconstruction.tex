...
\title{Ancestral Reconstruction: Theory \& Practice}
...
Though ancestral state reconstruction can also be undertaken for nucleotide sequence or other molecular characters (e.g., Yang 2014), in this chapter I'll focus on ancestral state reconstruction of phenotypic traits (Schluter et al. 1997; Nunn 2011; Revell and Harmon 2022). A phenotypic trait is an observable attribute -- be it physical, morphological, behavioral, ecological, physiological, cellular, etc. -- of the operational taxa of the tree. In the field of phylogenetic comparative biology, we conventionally subdivide phenotypic traits into two general categories (whilst realizing that some traits may not fall neatly into either): discrete and continuous (Pagel 1997; Felsenstein 2004; Revell and Harmon 2022; Revell 2024).
...
\hypertarget{joint-reconstruction}{%
...
In our example from Figure 1, there are a total of four possible \emph{sets} of states at the two nodes of the phylogeny: \([0,0]\), \([0,1]\), \([1,0]\), and \([1,1]\).\footnote{In general, there will be a number $k^m$ of such sets for $k$ character levels and $m$ nodes.} Uncoincidentally, these four sets of states correspond to the four terms of our equation for the probability of our data (\(P(0,0,1)\)), above. In other words:
...
\hypertarget{marginal-reconstruction-diel-activity-pattern-in-primates}{%
...
\hypertarget{joint-reconstruction-tail-spines-in-lizards}{%
...
\hypertarget{stochastic-character-mapping-leaf-armature-in-palms}{%
...
\hypertarget{the-brownian-motion-model}{%
...
\hypertarget{ancestral-state-estimation-under-brownian-motion}{%
...
In practice, rapid algorithms have been identified to find the set of internal node values that maximize the probability density of the data under our model (e.g., Rohlf 2001). In fact, Rohlf (2001) points out that the Maximum Likelihood ancestral state at any node \emph{i} can be expressed as a simple weighted average of the tip taxa values, in which the set of weights (\(\mathbf{w}_i\)) is given by the following expression.
...
\hypertarget{empirical-examples-1}{%
\subsection{Empirical examples}\label{empirical-examples-1}}

\hypertarget{brownian-motion-environmental-niche-evolution-in-liolaemid-lizards}{%
...
To explore ancestral character estimation for continuous characters under Brownian motion, I began with a dataset of maximum environmental temperature in degrees Celsius for lizards of the South American family Liolaemidae derived from Esquerré et al. (2019). With these data and phylogeny in hand, I proceeded to estimate ancestral states under a Brownian model of evolutionary change, and then projected the observed (at the tips) and reconstructed (along edges and at nodes) values onto the tree using a visualization method described in Revell (2013; 2014).
...
\hypertarget{brownian-motion-body-size-in-the-frog-genus-conraua}{%
...
\hypertarget{properties-of-ancestral-state-estimation}{%
...
A more pernicious problem arises when the model is wrong (Revell and Harmon 2022).\footnote{Or, rather `badly wrong' -- seeing how, in point of fact, all models are wrong, even if many are useful (to paraphrase the statistician George Box).} Under these circumstances, it becomes possible to \emph{confidently} estimate wrong ancestral node states.\footnote{This, too, one could argue, falls into the category of ancestral state reconstruction behaving as do all normal statistical methods! On the other hand, some evidence suggests that ancestral reconstruction is particularly sensitive to model assumption violations.}

To investigate ancestral state estimation when model assumptions are violated, I'll consider two different case studies: discrete character evolution under the hidden-rates model (Beaulieu et al. 2013); and bounded Brownian evolution (Boucher and Démery 2016). I will show that when an incorrect model is used (specifically, a homogenous-rate M\emph{k} model for the former data and unbounded Brownian motion for the latter), bad statistical behavior emerges. On the other hand, however, I will also show that this effect is substantively diminished under the correct, generating model for each case.

\hypertarget{ancestral-state-estimation-when-the-model-is-right}{%
...
\hypertarget{ancestral-state-estimation-when-the-model-is-wrong}{%
...
In addition to having the correct confidence intervals, estimates obtained under bounded Brownian motion were also more accurate (Figure 16b). The mean correlation between generating and estimated ancestral states when \emph{unbounded} Brownian evolution was assumed as a model for estimation was \(\bar{r} = 0.822\) -- compared to a mean of \(\bar{r} = 0.843\) when the correct model was used (Figure 16b).

\hypertarget{a-short-note-on-implementation}{%
...
\leavevmode\vadjust pre{\hypertarget{ref-Ane2008}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-BetancurR2015}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Blackburn2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Blomberg2003}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Boucher2016}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Cunningham1999}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Cunningham1998}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Danis2023}{}}%
Danis, T., and A. Rokas. 2023. The evolution of gestation length in eutherian mammals.

\leavevmode\vadjust pre{\hypertarget{ref-DurnCastillo2021}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Faurby2016}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Felsenstein2004-book}{}}%
Felsenstein, J. 2004. Inferring phylogenies. Sinauer associates, Sunderland, MA.

\leavevmode\vadjust pre{\hypertarget{ref-Felsenstein1973-a}{}}%
Felsenstein, J. 1973. Maximum-likelihood estimation of evolutionary trees from continuous characters. American Journal of Human Genetics 25:471--492.

\leavevmode\vadjust pre{\hypertarget{ref-Felsenstein1985}{}}%
Felsenstein, J. 1985. Phylogenies and the comparative method. Am. Nat. 125:1--15.

\leavevmode\vadjust pre{\hypertarget{ref-FitzJohn2009}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Gascuel2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Harmon2019-book}{}}%
Harmon, L. J. 2019. Phylogenetic comparative methods: Learning from trees. Ecoevorxiv.

\leavevmode\vadjust pre{\hypertarget{ref-Huelsenbeck2003}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Kirk2004}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Kissling2019}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Lewis2001}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Losos2011}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-MarugnLobn2021}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Nunn2011-book}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-OMeara2006}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Omland1999}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Onstein2022}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Pagel1994}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Pagel1997}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Pyron2013}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Quinn2021}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-RTeam2024}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Ramm2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Revell2014}{}}%
Revell, L. J. 2014. Graphical methods for visualizing comparative data on phylogenies. Pp. 77--103 \emph{in} L. Z. Garamszegi, ed. Modern phylogenetic comparative methods and their application in evolutionary biology: Concepts and practice. Springer Berlin Heidelberg, Berlin, Heidelberg.

\leavevmode\vadjust pre{\hypertarget{ref-Revell2024}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Revell2013}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Revell2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Santini2015}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Schluter1997}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Somarelli2017}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Spear2023}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Thomas2014}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Turakhia2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Walker2012}{}}%
